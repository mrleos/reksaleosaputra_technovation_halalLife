...
<html lang="en">
	...
	<head>
		...
		<link href="{{ asset('backend/assets/css/pages/login/classic/login-1.css') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				<!--begin::Aside-->
				<div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url({{ asset('backend/assets/media/bg/bg-4.jpg') }});">
					...
					<div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
						...
						<div class="login-form login-signup">
                            ...
                            <div class="position-absolute top-0 right-0 text-right mt-5 mb-15 mb-lg-0 flex-column-auto justify-content-center py-5 px-10">
                                ...
                                <a href="javascript:;" class="font-weight-bold ml-2" id="kt_login_signin">Sign In!</a>
                            </div>
